...
### Экспорт задач
- 📄 **Создание текстового файла** с задачами на день
- 📅 **Фильтрация по периодам**: сегодня, завтра, неделя, все
- 📋 **Форматы экспорта**:
  - **Подробный** — с контекстом, статистикой и эмодзи
  - **Markdown** — с чекбоксами для GitHub/Notion
  - **Простой** — только задачи и даты
- 📤 **Share Sheet** — отправка файла куда угодно
...
```
1. Нажмите кнопку экспорта (↑) в навигации
2. Выберите период: сегодня / завтра / неделя
3. Выберите формат: подробный / markdown / простой
4. Нажмите "Экспортировать"
5. Отправьте файл через Share Sheet

Результат: mindy-tasks-сегодня-2026-09-07.txt
```
